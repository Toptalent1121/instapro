	  		...
	  		<div class="card-header">
                ...
                <div class="pull-right">
                	<div class="btn-group" role="group" aria-label="export" style="position: relative; top: -7px;">
				    	<a href="<?=cn("caption/update")?>" class="btn btn-default"><i class="fa fa-plus"></i> <?=lang("add_new")?></a>
				   	</div>
                </div>
		  	</div>
	  	</div>
...
//                $title = $row['title'] ? $row['title'] : '#'.($page + $key + 1);
                $title = specialchar_decode(nl2br($row->title));
//                print_r($row);
              	...
              	<div class="card">
                	<div class="card-content">
	                  	<div class="card-body p15">
		                    <h4 class="card-title primary" style="font-size: 20px;"><?=$title;?></h4>
